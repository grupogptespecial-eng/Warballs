...
import { renderUnitPreview, druidHornsImg, druidStaffImg, paladinHelmImg, warriorShoulderImg } from '../render/visuals_module.js';
...
export function drawUnitThumb(ctx, klass, color, level){
  ...
  if(klass==='paladino'&&(!paladinHelmImg.complete||!paladinHelmImg.naturalWidth)) missing.push(paladinHelmImg);
