...
export const CLASSES = {
  ...
  guerreiro: { label: 'Guerreiro', color: '#f59e0b', hasRanged: true, cooldownMiraPercent: 0.20, weaponLen: 38, tipRadius: 10, omega: 3.6 }
};

export const THEMES = {
  dark: { grid: '#1f3046', grid2: '#1a2640', border: '#3b82f6', glow: '#7dd3fc' },
  light: { grid: '#d9e2f1', grid2: '#cfd8e6', border: '#64748b', glow: '#94a3b8' }
};
...
export const CFG = {
  ...
  monge: {
    ...
    baseBodyDamageL1: 9.6, bodyDamagePerLvl: 0.72,
    impulseOnHit: 280,
