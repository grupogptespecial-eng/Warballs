...
export const CLASSES = {
  ...
  guerreiro: { label: 'Guerreiro', color: '#f59e0b', hasRanged: true, cooldownMiraPercent: 0.15, weaponLen: 38, tipRadius: 5, omega: 3.6 },
...
export const WEAPON_VISUALS = {
  barbaro: { draw: 'axe', anchorDeg: 35, scale: 1.25, distanceFromCenter: 2.0 },
  ranger: { draw: 'bow', anchorDeg: -25, scale: 1.56, distanceFromCenter: 1.5, weaponAnchor: [-0.4, 0] },
  paladino: { draw: 'sword', anchorDeg: -90, scale: 1.6, distanceFromCenter: 2.0 },
  clerigo: { draw: 'mace', anchorDeg: 90, scale: 2.0, distanceFromCenter: 1.8 },
  bruxo: { draw: 'book', anchorDeg: -10, scale: 1.0, distanceFromCenter: 1.0 },
  bardo: { draw: 'flute', anchorDeg: 0, scale: 1.5, distanceFromCenter: 1.6 },
  artifice: { draw: 'arcaneCannon', anchorDeg: 40, scale: 1.8, distanceFromCenter: 1.5, weaponAnchor: [-0.2, 0] },
  guerreiro: { draw: 'spear', anchorDeg: 15, scale: 1.0, distanceFromCenter: 1.0, weaponAnchor: [0.48, 0] },
  druida: { draw: 'druidaStaff', anchorDeg: 90, scale: 1.5, distanceFromCenter: 1.6, weaponAnchor: [0, 0.5] }
};
